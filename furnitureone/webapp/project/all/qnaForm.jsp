...
<head>
	...
	<script >
		function checkField(){
			let inputs = document.qnaForm;
			if(!inputs.qtitle.value){
				alert("제목 입력해 주세요");
				return false;	
			}
			if(!inputs.qcontent.value){
				alert("내용을  입력해 주세요");
				return false;	
			}
...
<body>
	...
	<%} %>
		...
		<form action="qnaPro.jsp" method="post" name="qnaForm" onsubmit="return checkField()" enctype="multipart/form-data" >
		<table width="680" height="500" >
			...
			<tr>
				<td>내용</td>
				<td>
					<textarea cols="50" rows="20" name="qcontent" placeholder="문의사항을 입력해 주세요"></textarea>
				</td>
			</tr>
			<tr height="30">
